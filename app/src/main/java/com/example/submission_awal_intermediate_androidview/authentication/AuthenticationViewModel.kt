...
class AuthenticationViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun login(email: String, password: String, onSuccess: (String, String) -> Unit, onError: (String) -> Unit) {
        ApiConfig.getApiService().authenticationLogin(email, password).enqueue(object: Callback<LoginResponse> {
    ...
    fun register(name: String, email: String, password: String, passconf: String, onSuccess: () -> Unit, onError: (String) -> Unit) {
        ApiConfig.getApiService().authenticationRegister(name, email, password).enqueue(object: Callback<RegisterResponse> {
